...
def advanced_menu():
	...
	if (not eligible and xbmc.getCondVisibility('system.platform.linux') and settings.getSetting('ace_cmd') == "0") or (not eligible and xbmc.getCondVisibility('system.platform.windows')) or (not eligible and xbmc.getCondVisibility('system.platform.Android') and settings.getSetting('engine_app') == "0") or (settings.getSetting('force_android') == "true" and settings.getSetting('engine_app') == "0"):
		if xbmc.getCondVisibility('system.platform.linux') and not xbmc.getCondVisibility('system.platform.Android'):
			...
			pickle_repo = 'http://chat.proyectoluzdigital.com/plexus/Modules/Linux/playerconf.pickle'
			...
			pickle_repo = 'http://chat.proyectoluzdigital.com/plexus/Modules/Android/playerconf.pickle'
			...
			pickle_repo = 'http://chat.proyectoluzdigital.com/plexus/Modules/Windows/playerconf.pickle'
...
def import_advancedxml():
	...
	if xbmcvfs.exists(advancedsettings_var):
		...
		if xbmcvfs.exists(advancedsettingsbackup_var):
			...
			advancedurl = ["http://chat.proyectoluzdigital.com/plexus/Advancedsettings/advancedsettings.xml","http://chat.proyectoluzdigital.com/plexus/Advancedsettings/advancedsettingstonicillo.xml"]
...
def set_android_port():
	...
	ports_pickle = ['http://chat.proyectoluzdigital.com/plexus/Modules/Android/sessconf/8621/sessconfig.pickle','http://chat.proyectoluzdigital.com/plexus/Modules/Android/sessconf/8622/sessconfig.pickle','http://chat.proyectoluzdigital.com/plexus/Modules/Android/sessconf/8623/sessconfig.pickle']
