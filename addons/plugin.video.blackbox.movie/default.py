...
__home__ = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.blackbox.movie/', ''))
...
__art__ = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.blackbox.movie/art', ''))
__cbx_pages__ = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.blackbox.movie/art/cbx', ''))
__icons__ = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.blackbox.movie/art/icons', ''))
__libdir__ = xbmc.translatePath(os.path.join('special://xbmc/system/players/dvdplayer/', ''))
__tools__ = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.blackbox.movie/resources/tools', ''))
__addons__ = xbmc.translatePath(os.path.join('special://home/addons/', ''))
__resources__ = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.blackbox.movie/resources', ''))
...
# Entry point
def run():
    plugintools.log('[%s %s] ---> blackbox.movie.run <--- ' % (addonName, addonVersion))
...
def main_list(params):
    ...
    # Control del skin de Black Box Movie
    mastermenu = xml_skin()
    plugintools.log("XML menu: "+mastermenu)
    try:
        data = plugintools.read(mastermenu)
    except:
        mastermenu = 'http://pastebin.com/raw.php?i=uf4eqWJC'
        data = plugintools.read(mastermenu)
        xbmc.executebuiltin("Notification(%s,%s,%i,%s)" % ('Black Box Movie', "XML no reconocido...", 3 , __art__+'icon.png'))
...
def simpletv_items(params):
    ...
    if title == 'search.txt':
        ...
        data = file.readline()
        if data == "":
            ok = plugintools.message("Black Box Movie", "Sin resultados")
            return ok
    else:
        title = params.get("title")
            ...
            if data != "":
                ...
                if url == "#multilink":
                    ...
                    if cat == "":
                        if busqueda == 'search.txt':
                            ...
                            plugintools.add_item( action = "multilink" , plot = plot , extra = filename , title = '[COLOR white]' + title + ' [COLOR lightyellow][/COLOR]', url = url ,  thumbnail = thumbnail, info_labels = datamovie , show = show , page = show , fanart = fanart , folder = False , isPlayable = True )
                            if saving_url == 1:
                    ...
                    if cat == "":
                        if busqueda == 'search.txt':
                            ...
                            plugintools.add_item( action = "multiparser" , plot = datamovie["Plot"] , extra = filename , title = '[COLOR white]' + title + ' [COLOR lightyellow][/COLOR]', url = url ,  thumbnail = thumbnail, info_labels = datamovie , show = show , page = show , fanart = fanart , folder = True , isPlayable = False )
                            if saving_url == 1:
                    ...
                    # Sin categoría de canales   
                        ...
                        if busqueda == 'search.txt':
                            ...
                            if url.find("allmyvideos") >= 0:
                                ...
                                plugintools.add_item( action = "play" , title = '[COLOR red][I]' + '[/I][/COLOR][COLOR white]' + title + ' [COLOR blue][/COLOR]' , plot = plot , url = url , extra = show , thumbnail = thumbnail , fanart = fanart , folder = False , isPlayable = True )
                                params["show"]=show
                                plugintools.log("show "+show)
                                data = file.readline()
                                i = i + 1
                ...
                # Youtube playlist & channel    
                    ...
                    if busqueda == 'search.txt':
                        ...
                        url = 'plugin://plugin.video.youtube/playlist/'+pid
                        url = url.strip().replace(" ", "")
                        plugintools.add_item( action = "runPlugin" , title = '[COLOR white]' + title + ' [COLOR red][COLOR white][/COLOR]', url = url ,  thumbnail = thumbnail , fanart = fanart , show = show, folder = True , isPlayable = False )
                        data = file.readline()
                        i = i + 1
                        continue                   
                    ...
                    if busqueda == 'search.txt':
                        ...
                        if data.startswith("desc=") == True:
                            ...
                            if plugintools.get_setting("nolabel") == "true":
                                ...
                                plugintools.add_item( action = "getfile_http" , title = title + ' [COLOR orange][/COLOR]', info_labels = datamovie , url = url , thumbnail = thumbnail , fanart = fanart , show = show, folder = True , isPlayable = False )
                            data = file.readline()
                            i = i + 1
                            continue
                        else:
                            ...
                            if plugintools.get_setting("nolabel") == "true":
                                ...
                                plugintools.add_item( action = "getfile_http" , title = title + ' [COLOR orange][/COLOR]', url = url ,  thumbnail = thumbnail , fanart = fanart , show = show, folder = True , isPlayable = False )                                                
                            i = i + 1
                            continue
                    ...
                    if busqueda == 'search.txt':
                        ...
                        url = data.replace("plx:", "")
                        # Se añade parámetro plot porque en las listas PLX no tengo en una función separada la descarga (FIX IT!)                        
                        plugintools.add_item( action = "plx_items" , plot = "" , title = title + ' [COLOR orange][/COLOR]', url = url ,  thumbnail = thumbnail , fanart = fanart , show = show, folder = True , isPlayable = False )
                        data = file.readline()
                        i = i + 1
                        continue
...
def search_channel(params):
    ...
    if buscar == "":
        ...
        cat = ""
        if texto == "":
            errormsg = plugintools.message("Black Box Movie","Por favor, introduzca el canal a buscar")
            return errormsg
            ...
            while data <> "" :
                if data.startswith("#") == True:
                    ...
                    if url.startswith("yt_channel") == True:
                        ...
                        if url.find("allmyvideos") >= 0:
                            plugintools.add_item(action="allmyvideos" , title = title + ' [COLOR lightyellow][/COLOR]' , extra = show, url = url , info_labels = datamovie , thumbnail = thumbnail , fanart = fanart , folder = False , isPlayable = True)
                            plugintools.log("URL= "+url)
                            break

                        elif url.find("streamcloud") >= 0:
                            plugintools.add_item(action="streamcloud" , title = title + ' [COLOR lightskyblue][/COLOR]' , extra = show, url = url , thumbnail = thumbnail , fanart = fanart , folder = False , isPlayable = True)
                            plugintools.log("URL= "+url)
                            plugintools.log("FANART = "+fanart)
                            break

                        elif url.find("played.to") >= 0:
                            plugintools.add_item(action="playedto" , title = title + ' [COLOR lavender][/COLOR]' , url = url , extra = show, thumbnail = thumbnail , fanart = fanart , folder = False , isPlayable = True)
                            plugintools.log("URL= "+url)
                            plugintools.log("FANART = "+fanart)
                            break

                        elif url.find("vidspot") >= 0:
                            plugintools.add_item(action="vidspot" , title = title + ' [COLOR palegreen][/COLOR]' , url = url , extra = show, thumbnail = thumbnail , fanart = fanart , folder = False , isPlayable = True)
                            plugintools.log("URL= "+url)
                            plugintools.log("FANART = "+fanart)
                            break

                        elif url.find("vk.com") >= 0:
                            plugintools.add_item(action="vk" , title = title + ' [COLOR royalblue][/COLOR]' , url = url , extra = show, thumbnail = thumbnail , fanart = fanart , folder = False , isPlayable = True)
                            plugintools.log("URL= "+url)
                            plugintools.log("FANART = "+fanart)
                            break

                        elif url.find("nowvideo") >= 0:
                            plugintools.add_item(action="nowvideo" , title = title + ' [COLOR red][/COLOR]' , url = url , extra = show, thumbnail = thumbnail , fanart = fanart , folder = False , isPlayable = True)
                            plugintools.log("URL= "+url)
                            break
                            ...
                            plugintools.add_item(action="streaminto" , title = title + ' [COLOR orange][/COLOR]' , url = url , thumbnail = thumbnail , extra = show, fanart = fanart , folder = False , isPlayable = True)
                            plugintools.log("URL= "+url)
                            break
                            ...
                            plugintools.add_item( action = "play" , title = title + ' [COLOR red][COLOR white][/COLOR]', url = url , extra = show, thumbnail = thumbnail , fanart = fanart , folder = False , isPlayable = True )
                            break
                        ...
                        title = parser_title(title)
                        url = launch_torrent(url)
                        plugintools.add_item(action="play" , title = title + ' [COLOR orangered][/COLOR]' , extra = show, url = url, thumbnail = thumbnail , fanart = fanart , folder = False , isPlayable = True)
                        break
...
def p2p_items(params):
    ...
    data = plugintools.read("http://pastebin.com/raw.php?i=uf4eqWJC")
    ...
    # Controlamos el caso en que no haya thumbnail en el menú de Black Box Movie
    if thumbnail == "":
...
def contextMenu(params):
    ...
    if len_canales == 1:
        ...
        if len_canales == 2:
            ...
            selector = dialog.select('Black Box Movie', [tv_a, tv_b])
            ...
            selector = dialog.select('Black Box Movie', [tv_a, tv_b, tv_c])
            ...
            selector = dialog.select('Black Box Movie', [tv_a, tv_b, tv_c, tv_d])
            ...
            selector = dialog.select('Black Box Movie', [tv_a, tv_b, tv_c, tv_d, tv_e])
            ...
            selector = dialog.select('Black Box Movie', [tv_a , tv_b, tv_c, tv_d, tv_e, tv_f])
            ...
            selector = dialog.select('Black Box Movie', [tv_a , tv_b, tv_c, tv_d, tv_e, tv_f, tv_g])
...
def tinyurl(params):
    ...
    xbmc.executebuiltin("Notification(%s,%s,%i,%s)" % ('Black Box Movie', "Redireccionando enlace...", 3 , __art__+'icon.png'))
...
def xml_skin():
    ...
    if xmlmaster == 'true':
        if SelectXMLmenu == '0':  # Default skin
            mastermenu = 'http://pastebin.com/raw.php?i=uf4eqWJC'
            plugintools.log("[blackbox.movie.xml_skin: "+SelectXMLmenu)
            
            # Control para ver la intro de Black Box Movie
            ...
            if id_pastebin == "":
                plugintools.log("[blackbox.movie.xml_skin: No definido")
                mastermenu = 'http://pastebin.com/raw.php?i=uf4eqWJC'
            else:
                mastermenu = 'http://pastebin.com/raw.php?i=' +id_pastebin
                plugintools.log("[blackbox.movie.xml_skin: "+mastermenu)
...
def cbx_reader(params):
    ...
    if url.find("mediafire") >= 0:  # ***************** MEDIAFIRE *****************
        ...
        progreso.create("Black Box Movie", "Iniciando descarga de [I]Mediafire[/I] en [I][B]playlists/tmp[/B][/I]\n")
        ...
        if os.path.isfile(src_cbx) is False:
            ...
            if url.endswith("cbz") == True:
                progreso.create("Black Box Movie", "Descargando archivo CBZ en [I][B]playlists/tmp[/B][/I]")
            elif url.endswith("cbr") == True:
                progreso.create("Black Box Movie", "Descargando archivo CBR en [I][B]playlists/tmp[/B][/I]")
            elif url.find("copy.com") >= 0:
                if url.find("cbr") >= 0:
                    progreso.create("Black Box Movie", "Descargando archivo CBR de Copy.com en [I][B]playlists/tmp[/B][/I]")
                elif url.find("cbz") >= 0:
                    progreso.create("Black Box Movie", "Descargando archivo CBZ de Copy.com en [I][B]playlists/tmp[/B][/I]")
            # response = urllib2.urlopen(url)
            # body = response.read()
    ...
    #xbmc.executebuiltin("Notification(%s,%s,%i,%s)" % ('Black Box Movie', "Descompresión fallida", 3 , __art__+'icon.png'))
