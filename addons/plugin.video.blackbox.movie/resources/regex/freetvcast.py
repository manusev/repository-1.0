# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Black Box Movie Regex de freetvcast
...
def freetvcast(params):
    plugintools.log("[blackbox.movie-0.3.0].resolve_freetvcast " + repr(params) )
...
def play_freetvcast(freetvcast_user):
    plugintools.log("[blackbox.movie-0.3.0].freetvcast User= " + repr(freetvcast_user) )
