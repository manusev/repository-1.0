# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Black Box Movie Regex de 9straem
...
def ninestreams(params):
    plugintools.log("[blackbox.movie-0.3.0].ninestreams "+repr(params))
    url_user = {}
...
def getparams_ninestream(url_user, params, body):
    plugintools.log("[blackbox.movie-0.3.0].getparams_ninestream " + repr(url_user) )
...
def getfile_ninestream(url_user, decoded, body):
    plugintools.log("blackbox.movie getfile_ninestream( "+repr(url_user))
    referer = url_user.get("referer")
...
def get_fileserver(decoded, url_user):
    plugintools.log("blackbox.movie fileserver "+repr(url_user))
