...
def freebroadcast(params):
    plugintools.log("[blackbox.movie-0.3.0].freebroadcast "+repr(params))
    url_user = {}
...
def getparams_freebroadcast(url_user, body):
    plugintools.log("[blackbox.movie-0.3.0].getparams_freebroadcast " + repr(url_user) )
...
def getfile_freebroadcast(url_user, decoded, body):
    plugintools.log("blackbox.movie getfile_freebroadcast( "+repr(url_user))
    referer = url_user.get("referer")
