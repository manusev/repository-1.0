# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Black Box Movie Regex de castalba
...
# En construcción!
def castalba(params):
    plugintools.log("[blackbox.movie-0.3.0].castalba "+repr(params))
...
def castalba(params):
    ...
    if body.find("THIS CHANNEL IS CURRENTLY OFFLINE") > 0 :
        xbmc.executebuiltin("Notification(%s,%s,%i,%s)" % ('Black Box Movie', "Canal offline", 3 , art+'icon.png'))
        return 0
    else:
