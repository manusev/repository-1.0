# -*- coding: utf-8 -*-
#------------------------------------------------------------
# EPG ¿Qué ver ahora? para Black Box Movie
...
temp = xbmc.translatePath(os.path.join('special://home/userdata/addon_data/plugin.video.blackbox.movie/tmp', ''))
playlist = xbmc.translatePath(os.path.join('special://home/userdata/addon_data/plugin.video.blackbox.movie/playlists', ''))
