# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Mundoplus.tv parser para Black Box Movie
...
def mundoplus_guide(params):
    plugintools.log("[blackbox.movie 0.3.3].Mundoplus.tv "+repr(params))
...
def mundoplus0(params):
    ...
    try:
        ...
        params["plot"]=texto
        texto = texto.lower()        
        if texto == "": errormsg = plugintools.message("Black Box Movie","Por favor, introduzca serie a buscar");return errormsg
        else:
...
def mundoplus1(params):
    plugintools.log("[blackbox.movie 0.3.3].Mundoplus.tv búsqueda "+repr(params))
...
def gethttp_referer_headers(url,referer):
    plugintools.log("blackbox.movie 0.3.3 Gethttp_referer_headers "+url)
    request_headers=[]
