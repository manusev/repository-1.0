...
def multiparse_title(title, url, show):
    ...
    if url == "mundoplus":
        ...
        if url.find("seriesflv") >= 0:
            title = title + ' [COLOR blue][B][SeriesFLV][/B][/COLOR]'
        if url.find("seriesyonkis") >= 0:
            title = title + ' [COLOR blue][B][SeriesYonkis][/B][/COLOR]'
        if url.find("seriesadicto") >= 0:
            title = title + ' [COLOR blue][B][SeriesAdicto][/B][/COLOR]'
        if url.find("seriesblanco") >= 0:
            title = title + ' [COLOR blue][B][SeriesBlanco][/B][/COLOR]'
        if url.find("series.mu") >= 0:
            title = title + ' [COLOR blue][B][Series.Mu][/B][/COLOR]'            
        ...
        if url.find("allmyvideos") >= 0:
            title = title + ' [COLOR blue][B][Allmyvideos][/B][/COLOR]'

        elif url.find("streamcloud") >= 0:
            title = title + ' [COLOR blue][B][Streamcloud][/B][/COLOR]'

        elif url.find("vidspot") >= 0:
            title = title + ' [COLOR blue][B][Vidspot][/B][/COLOR]'
            
        elif url.find("played.to") >= 0:
            title = title + ' [COLOR blue][B][Played.to][/B][/COLOR]'       

        elif url.find("vk.com") >= 0:
            title = title + ' [COLOR blue][B][Vk][/B][/COLOR]'

        elif url.find("nowvideo") >= 0:
            title = title + ' [COLOR blue][B][Nowvideo.sx][/B][/COLOR]'            
        
        elif url.find("tumi") >= 0:
            title = title + ' [COLOR blue][B][Tumi][/B][/COLOR]'

        elif url.find("streamin.to") >= 0:
            title = title + ' [COLOR blue][B][Streamin.to][/B][/COLOR]'

        elif url.find("veehd") >= 0:
            title = title + ' [COLOR blue][B][Veehd][/B][/COLOR]'
            
        elif url.find("tumi.tv") >= 0:
            title = title + ' [COLOR blue][B][Tumi.tv][/B][/COLOR]'       

        elif url.find("novamov") >= 0:
            title = title + ' [COLOR blue][B][Novamov][/B][/COLOR]'

        elif url.find("gamovideo") >= 0:
            title = title + ' [COLOR blue][B][Gamovideo][/B][/COLOR]'            
        
        elif url.find("moevideos") >= 0:
            title = title + ' [COLOR blue][B][Moevideos][/B][/COLOR]'

        elif url.find("movshare") >= 0:
            title = title + ' [COLOR blue][B][Movshare][/B][/COLOR]'

        elif url.find("powvideo") >= 0:
            title = title + ' [COLOR blue][B][Powvideo][/B][/COLOR]'

        elif url.find("mail.ru") >= 0:
            title = title + ' [COLOR blue][B][Mail.ru][/B][/COLOR]'

        elif url.find("netu") >= 0:
            title = title + ' [COLOR blue][B][Netu][/B][/COLOR]'

        elif url.find("videobam") >= 0:
            title = title + ' [COLOR blue][B][Videobam][/B][/COLOR]'              

        elif url.find("www.youtube.com") >= 0:
            title = title + ' [COLOR red][B][Youtube][/B][/COLOR]'

        elif url.find("dailymotion.com/video") >= 0:
            title = title + ' [COLOR green][I][Dailymotion Video][/I][/COLOR]'

        elif url.find("dailymotion.com/playlist") >= 0:
            title = title + ' [COLOR green][I][Dailymotion Playlist][/I][/COLOR]'            
