# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Black Box Movie Parser de Goear
...
def goear(params):
    plugintools.log("blackbox.movie Goear: ")
...
def goear_def(url):
    plugintools.log("[blackbox.movie 0.3.0].goear")
...
def gethttp_referer_headers(url,referer,show):
    plugintools.log("blackbox.movie-0.3.0.gethttp_referer_headers ")
    modo_vista(show)
    request_headers=[]
