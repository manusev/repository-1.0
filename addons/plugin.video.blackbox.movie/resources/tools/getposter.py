# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Black Box Movie GetPoster (módulo de descarga de posters de películas)
...
def save_title(title, datamovie, filename):
    plugintools.log("Black Box Movie Saving data... "+repr(datamovie))
...
def save_url(url, filename):
    plugintools.log("Black Box Movie Saving URL...")
