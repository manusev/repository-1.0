...
def multilink(params):
    ...
    encuentra = '#EXTINF:-1,' + title.replace(" [COLOR lightyellow][/COLOR]","").replace("[COLOR white]", "")
    if encuentra.startswith("#EXTINF:-1,@") == True:
        title_epg = title.replace("[COLOR white]","").split("[COLOR red")
        if len(title_epg) >= 1:
...
def multiparse_title(title, url, show):
    ...
    if url == "mundoplus":
        ...
        if url.find("seriesflv") >= 0:
            title = title + ' [COLOR green][B][SeriesFLV[/B]][/COLOR]'
        if url.find("seriesyonkis") >= 0:
            title = title + ' [COLOR green][B][SeriesYonkis[/B]][/COLOR]'
        if url.find("seriesadicto") >= 0:
            title = title + ' [COLOR green][B][SeriesAdicto[/B]][/COLOR]'
        if url.find("seriesblanco") >= 0:
            title = title + ' [COLOR green][B][SeriesBlanco[/B]][/COLOR]'
        if url.find("series.mu") >= 0:
            title = title + ' [COLOR green][B][Series.Mu[/B]][/COLOR]'            

    elif url.startswith("goear") == True:
        title = title + ' [COLOR green][B][goear][/B][/COLOR]'        
        ...
        if url.find("allmyvideos") >= 0:
            ...
            title = title + ' [COLOR green][B][Youtube][/B][/COLOR]'

        elif url.find("dailymotion.com/video") >= 0:
            title = title + ' [COLOR green][B][Dailymotion Video][/B][/COLOR]'

        elif url.find("dailymotion.com/playlist") >= 0:
            title = title + ' [COLOR green][B][Dailymotion Playlist][/B][/COLOR]'            

        elif url.find(".m3u8") >= 0:
            title = title + ' [COLOR green][B][M3u8][/B][/COLOR]'

        else:
            title = title + ' [COLOR green][B][HTTP][/B][/COLOR]'
            
    elif url.startswith("rtmp") == True:        
        if url.find("iguide.to") >= 0:
            title = title + ' [COLOR green][B][iguide][/B][/COLOR]'
        elif url.find("freetvcast.pw") >= 0:
            title = title + ' [COLOR green][B][freetvcast][/B][/COLOR]'
        elif url.find("pageUrl=http://privado.streamingfreetv.net") >= 0:
            title = title + ' [COLOR green][B][streamingfreetv][/B][/COLOR]'
        elif url.find("9stream") >= 0:
            title = title + ' [COLOR green][B][9stream][/B][/COLOR]'
        elif url.find("freebroadcast") >= 0:
            title = title + ' [COLOR green][B][freebroadcast][/B][/COLOR]'
        elif url.find("cast247") >= 0:
            title = title + ' [COLOR green][B][cast247][/B][/COLOR]'
        elif url.find("castalba") >= 0:
            title = title + ' [COLOR green][B][castalba][/B][/COLOR]'
        elif url.find("direct2watch") >= 0:
            title = title + ' [COLOR green][B][direct2watch][/B][/COLOR]'
        elif url.find("vaughnlive") >= 0:
            title = title + ' [COLOR green][B][vaughnlive][/B][/COLOR]'
        elif url.find("sawlive") >= 0:
            title = title + ' [COLOR green][B][sawlive][/B][/COLOR]'        
        elif url.find("shidurlive") >= 0:
            title = title + ' [COLOR green][B][shidurlive][/B][/COLOR]'
        elif url.find("vercosas") >= 0:
            title = title + ' [COLOR green][B][vercosas][/B][/COLOR]'
        elif url.find("pageUrl=http://rdmcast.com") >= 0:
            title = title + ' [COLOR green][B][rdmcast][/B][/COLOR]'
        elif url.find("businessapp1") >= 0:
            title = title + ' [COLOR green][B][businessapp1][/B][/COLOR]'             
        else:
            title = title + ' [COLOR green][B][rtmp][/B][/COLOR]'            
            
    elif url.startswith("udp") == True:
        title = title + ' [COLOR green][B][udp][/B][/COLOR]'         
    
    elif url.startswith("rtp") == True:
        title = title + ' [COLOR green][B][rtp][/B][/COLOR]'            
    
    elif url.startswith("mms") == True:
        title = title + ' [COLOR green][B][mms][/B][/COLOR]'      
        ...
        if url.find("youtube") >= 0 :
            ...
            title = title + ' [COLOR green][B][Acestream][/B][/COLOR]'
            
        elif url.find("mode=2") >= 0 :
            title = title + ' [COLOR green][B][Sopcast][/B][/COLOR]'
            
    elif url.startswith("magnet") == True:
        title = title + ' [COLOR green][B][Torrent][/B][/COLOR]'
        ...
        if url.startswith("yt_playlist") == True:
            title = title + ' [COLOR green][B][Youtube Playlist][/B][/COLOR]'

        elif url.startswith("yt_channel") == True:
            title = title + ' [COLOR green][B][Youtube Channel][/B][/COLOR]'

    elif url.startswith("bum") == True:
        title_fixed = title
        title = title + ' [COLOR green][B][BUM+][/B][/COLOR]'        
        params = plugintools.get_params()
        params["title"] = title_fixed
        plugintools.log("params_fixed = "+repr(params))

    elif url.startswith("wuarron") == True:
        title = title + ' [COLOR green][B][Wuarron][/B][/COLOR]'

    elif url.startswith("devil") == True:
        title = title + ' [COLOR green][B][SportsDevil][/B][/COLOR]'

    elif url.startswith("short") == True:
        title = title + ' [COLOR green][B][ShortLink][/B][/COLOR]'        

    elif url.startswith("img") == True:
        title = title + ' [COLOR green][B][IMG][/B][/COLOR]'        
        
    else:
        plugintools.log("URL desconocida= "+url)
        title = title + ' [COLOR green][B][Unknown][/B][/COLOR]'
