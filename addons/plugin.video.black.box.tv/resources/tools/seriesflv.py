# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Black Box TV Parser de SeriesFLV.com
...
def seriesflv(params):
    plugintools.log("[black.box.tv 0.3.0].SeriesFLV")
...
def categorias_flv(data,show):
    plugintools.log("[black.box.tv 0.3.4] SeriesFLV Categorias ")
...
def lista_chapters(params):
    plugintools.log("[black.box.tv 0.3.4] SeriesFLV Lista_chapters "+repr(params))
...
def listado_seriesflv(params):
    plugintools.log("black.box.tv.[listado_seriesflv] "+repr(params))
