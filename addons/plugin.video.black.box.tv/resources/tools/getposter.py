# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Black Box TV GetPoster (módulo de descarga de posters de películas)
...
def save_title(title, datamovie, filename):
    plugintools.log("black.box.tv Saving data... "+repr(datamovie))
...
def save_url(url, filename):
    plugintools.log("black.box.tv Saving URL...")
