# -*- coding: utf-8 -*-
#------------------------------------------------------------
# EPG ¿Qué ver ahora? para Black Box TV
...
temp = xbmc.translatePath(os.path.join('special://home/userdata/addon_data/plugin.video.black.box.tv/tmp', ''))
playlist = xbmc.translatePath(os.path.join('special://home/userdata/addon_data/plugin.video.black.box.tv/playlists', ''))
...
def epg_verahora(params):
    ...
    plugintools.add_item(action="", title= '[COLOR white][B]Teletexto Emisiónes Ahora[/B][/COLOR]', thumbnail = thumbnail , fanart = fanart , folder = False, isPlayable = False)
    ...
    for entry in body:
        ...
        plugintools.add_item(action="", title= '[COLOR blue][B]'+channel+' [COLOR white]'+ahora+'[/COLOR] [COLOR green]('+diff_luego+') [/COLOR][COLOR red]'+hora_luego+' [/COLOR][/B] '+evento_luego, thumbnail = thumbnail , fanart = fanart , folder = False, isPlayable = False)
...
def epg_verluego(params):
    ...
    data = plugintools.read(url)
    #plugintools.log("data= "+data)
    plugintools.add_item(action="", title= '[COLOR white][B]Teletexto Emisiónes Después[/B][/COLOR]', thumbnail = thumbnail , fanart = fanart , folder = False, isPlayable = False)
    ...
    for entry in body:
        ...
        plugintools.add_item(action="", title= '[COLOR blue][B]'+channel+' [COLOR red] '+hora_luego+' [COLOR white]'+evento_luego+'[/COLOR][COLOR green] ('+diff_luego+') [/COLOR][COLOR red]'+hora_mastarde+' [COLOR white][/COLOR][/B]'+evento_mastarde, thumbnail = thumbnail , fanart = fanart , folder = False, isPlayable = False)
...
def epg_vermastarde(params):
    ...
    data = plugintools.read(url)
    #plugintools.log("data= "+data)
    plugintools.add_item(action="", title= '[COLOR white][B]Teletexto Emisiónes Mas Tarde[/B][/COLOR]', thumbnail = thumbnail , fanart = fanart , folder = False, isPlayable = False)
    ...
    for entry in body:
        ...
        hora_mastarde = hora_mastarde.split("</span>")
        hora_mastarde = hora_mastarde[0]        
        plugintools.add_item(action="", title= '[COLOR blue][B]'+channel+' [COLOR red]'+hora_mastarde + '[COLOR white]  '+evento_mastarde+'[/B][/COLOR]', thumbnail = thumbnail , fanart = fanart , folder = False, isPlayable = False)
