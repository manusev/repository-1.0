...
def epg_arena(url):
    plugintools.log("[black.box.tv-0.3.0].EPG EHF.com loading... "+url)
...
def get_program(horas, eventos, url):
    plugintools.log("[black.box.tv-0.3.1].get_program "+url)
...
def encode_string(txt):
    plugintools.log("[black.box.tv-0.3.0].encode_string: "+txt)
...
def gethttp_noref(url):
    plugintools.log("[black.box.tv-0.3.0.gethttp_noref] "+url)    
...
def compara_times(horas, eventos):
    plugintools.log("[black.box.tv-0.3.1].compara_times")
    print horas, eventos
