...
def bajalib(params, platform, libdir, filename):
    plugintools.log("[black.box.tv-0.2.99].bajalib "+platform)
    ...
    xbmc.executebuiltin("Notification(%s,%s,%i,%s)" % ('Black Box TV', "Librería actualizada!", 3 , art+'icon.png'))
    return 0 #succesful



def get_system_platform(params):
    plugintools.log("[black.box.tv-0.2.99].get_system_platform " + repr(params))
