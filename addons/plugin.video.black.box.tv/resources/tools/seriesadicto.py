...
def seriecatcher(params):
    plugintools.log("[black.box.tv 0.3.3].seriecatcher "+repr(params))
...
def GetSerieChapters(params):
    plugintools.log("[black.box.tv 0.3.3].GetSerieChapters "+repr(params))
...
def GetSerieLinks(params):
    plugintools.log("black.box.tv GetSerieLinks "+repr(params))
...
def SelectTemp(params, temp):
    plugintools.log("[black.box.tv 0.3.3].SelectTemp "+repr(params))
    ...
    if seasons == 11:
        selector = dialog.select('Black Box TV', [temp[0], temp[1],temp[2], temp[3], temp[4], temp[5], temp[6], temp[7], temp[8], temp[9], temp[10]])

    if seasons == 12:
        selector = dialog.select('Black Box TV', [temp[0], temp[1],temp[2], temp[3], temp[4], temp[5], temp[6], temp[7], temp[8], temp[9], temp[10], temp[11]])

    if seasons == 13:
        selector = dialog.select('Black Box TV', [temp[0], temp[1],temp[2], temp[3], temp[4], temp[5], temp[6], temp[7], temp[8], temp[9], temp[10], temp[11], temp[12]])

    if seasons == 14:
        selector = dialog.select('Black Box TV', [temp[0], temp[1],temp[2], temp[3], temp[4], temp[5], temp[6], temp[7], temp[8], temp[9], temp[10], temp[11], temp[12], temp[13]])

    if seasons == 15:
        selector = dialog.select('Black Box TV', [temp[0], temp[1],temp[2], temp[3], temp[4], temp[5], temp[6], temp[7], temp[8], temp[9], temp[10], temp[11], temp[12], temp[13], temp[14]])

    if seasons == 16:
        selector = dialog.select('Black Box TV', [temp[0], temp[1],temp[2], temp[3], temp[4], temp[5], temp[6], temp[7], temp[8], temp[9], temp[10], temp[11], temp[12], temp[13], temp[14], temp[15]])

    if seasons == 17:
        selector = dialog.select('Black Box TV', [temp[0], temp[1],temp[2], temp[3], temp[4], temp[5], temp[6], temp[7], temp[8], temp[9], temp[10], temp[11], temp[12], temp[13], temp[14], temp[15], temp[16]])

    if seasons == 18:
        selector = dialog.select('Black Box TV', [temp[0], temp[1],temp[2], temp[3], temp[4], temp[5], temp[6], temp[7], temp[8], temp[9], temp[10], temp[11], temp[12], temp[13], temp[14], temp[15], temp[16], temp[17]])

    if seasons == 19:
        selector = dialog.select('Black Box TV', [temp[0], temp[1],temp[2], temp[3], temp[4], temp[5], temp[6], temp[7], temp[8], temp[9], temp[10], temp[11], temp[12], temp[13], temp[14], temp[15], temp[16], temp [17], temp[18]])

    if seasons == 20:
        selector = dialog.select('Black Box TV', [temp[0], temp[1],temp[2], temp[3], temp[4], temp[5], temp[6], temp[7], temp[8], temp[9], temp[10], temp[11], temp[12], temp[13], temp[14], temp[15], temp[16], temp [17], temp[18], temp[19]])

    if seasons == 21:
        selector = dialog.select('Black Box TV', [temp[0], temp[1],temp[2], temp[3], temp[4], temp[5], temp[6], temp[7], temp[8], temp[9], temp[10], temp[11], temp[12], temp[13], temp[14], temp[15], temp[16], temp [17], temp[18], temp[19], temp[20]])

    if seasons == 22:
        selector = dialog.select('Black Box TV', [temp[0], temp[1],temp[2], temp[3], temp[4], temp[5], temp[6], temp[7], temp[8], temp[9], temp[10], temp[11], temp[12], temp[13], temp[14], temp[15], temp[16], temp [17], temp[18], temp[19], temp[20], temp[21]])

    if seasons == 23:
        selector = dialog.select('Black Box TV', [temp[0], temp[1],temp[2], temp[3], temp[4], temp[5], temp[6], temp[7], temp[8], temp[9], temp[10], temp[11], temp[12], temp[13], temp[14], temp[15], temp[16], temp [17], temp[18], temp[19], temp[20], temp[21], temp[22]])
        
    if seasons == 24:
        selector = dialog.select('Black Box TV', [temp[0], temp[1],temp[2], temp[3], temp[4], temp[5], temp[6], temp[7], temp[8], temp[9], temp[10], temp[11], temp[12], temp[13], temp[14], temp[15], temp[16], temp [17], temp[18], temp[19], temp[20], temp[21], temp[22], temp[23]])
        
    if seasons == 25:
        selector = dialog.select('Black Box TV', [temp[0], temp[1],temp[2], temp[3], temp[4], temp[5], temp[6], temp[7], temp[8], temp[9], temp[10], temp[11], temp[12], temp[13], temp[14], temp[15], temp[16], temp [17], temp[18], temp[19], temp[20], temp[21], temp[22], temp[23], temp[24]])

    if seasons == 26:
        selector = dialog.select('Black Box TV', [temp[0], temp[1],temp[2], temp[3], temp[4], temp[5], temp[6], temp[7], temp[8], temp[9], temp[10], temp[11], temp[12], temp[13], temp[14], temp[15], temp[16], temp [17], temp[18], temp[19], temp[20], temp[21], temp[22], temp[23], temp[24], temp[25]])
