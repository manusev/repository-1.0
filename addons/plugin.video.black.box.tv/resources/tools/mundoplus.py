# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Mundoplus.tv parser para Black Box TV
...
def mundoplus_guide(params):
    plugintools.log("[black.box.tv 0.3.3].Mundoplus.tv "+repr(params))
...
def mundoplus0(params):
    ...
    try:
        ...
        params["plot"]=texto
        texto = texto.lower()        
        if texto == "": errormsg = plugintools.message("Black Box TV","Por favor, introduzca serie a buscar");return errormsg
        else:
...
def mundoplus1(params):
    plugintools.log("[black.box.tv 0.3.3].Mundoplus.tv búsqueda "+repr(params))
