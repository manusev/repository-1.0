# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Black Box TV Regex de Shidurlive
...
def shidurlive(params):
    plugintools.log("[black.box.tv-0.3.0].shidurlive "+repr(params))
    url_user = {}
...
def getparams_shidurlive(url_user, body):
    plugintools.log("[black.box.tv-0.3.0].getparams_shidurlive " + repr(url_user) )
