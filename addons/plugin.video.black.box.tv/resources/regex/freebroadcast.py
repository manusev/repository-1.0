# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Black Box TV - XBMC Add-on by Juarrox (juarrox@gmail.com)
...
def freebroadcast(params):
    plugintools.log("[black.box.tv-0.3.0].freebroadcast "+repr(params))
    url_user = {}
...
def getparams_freebroadcast(url_user, body):
    plugintools.log("[black.box.tv-0.3.0].getparams_freebroadcast " + repr(url_user) )
...
def getfile_freebroadcast(url_user, decoded, body):
    plugintools.log("black.box.tv getfile_freebroadcast( "+repr(url_user))
    referer = url_user.get("referer")
...
def get_fileserver(decoded, url_user):
    plugintools.log("black.box.tv fileserver "+repr(url_user))
