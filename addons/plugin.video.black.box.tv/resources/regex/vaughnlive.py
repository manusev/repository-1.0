# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Black Box TV Regex de vaughnlive
...
def resolve_vaughnlive(params):
    plugintools.log("[black.box.tv-0.3.0].resolve_vaughnlive " + repr(params) )
    ...
    # black.box.tv: rtmp://198.255.5.66:443/live?0n0qMt6OtXhOLwQKIwSoxVdmXHiYW8nVZSY playpath=live_dibujos_animados live=1 timeout=20
...
def gethttp_noref(url):
    plugintools.log("[black.box.tv-0.3.0.Vaughn_Regex] ")    
