# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Black Box TV Regex de direct2watch
...
def directwatch(params):
    plugintools.log("[black.box.tv-0.3.0].directwatch "+repr(params))
    url_user = {}
...
def gethttp_referer_headers(pageurl, referer):
    plugintools.log("[black.box.tv-0.3.0].gethttp_headers "+pageurl)
