# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Black Box TV Regex de freetvcast
...
def freetvcast(params):
    plugintools.log("[black.box.tv-0.3.0].resolve_freetvcast " + repr(params) )
...
def play_freetvcast(freetvcast_user):
    plugintools.log("[black.box.tv-0.3.0].freetvcast User= " + repr(freetvcast_user) )
