...
cbx_pages = xbmc.translatePath(os.path.join('special://home/userdata/adon_data/plugin.video.black.box.tv/art/cbx', ''))
playlists = xbmc.translatePath(os.path.join('special://home/userdata/addon_data/plugin.video.black.box.tv/playlists', ''))
tmp = xbmc.translatePath(os.path.join('special://home/userdata/addon_data/plugin.video.black.box.tv/tmp', ''))
